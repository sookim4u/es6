	...
	class ToolbarPanel {
		...
		initLayout(toolbar) {
			...
			let clickHandler = function() {
				...
				toolbarThis.graphView.setMinXValue(minXValue);
				toolbarThis.graphView.setMinYValue(minYValue);

				toolbarThis.graphView.setMaxXValue(maxXValue);
				toolbarThis.graphView.setMaxYValue(maxYValue);

				toolbarThis.graphView.setTickXValue(xTickValue);
				toolbarThis.graphView.setTickYValue(yTickValue);

				toolbarThis.graphView.makePlotPoints(equation);

				toolbarThis.graphView.redraw();
			};
